...
class Trainer_li(BaseTrainer):
    ...
    def train_step(self, input_batch):
        ...
        if self.options.run_smplify:
            ...
            pred_pose = rotation_matrix_to_angle_axis(pred_rotmat_hom).contiguous().view(batch_size*4, -1)
        ...
        valid_fit1 = (opt_joint_loss < self.options.smplify_threshold).to(self.device)
